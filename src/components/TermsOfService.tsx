...
export default function TermsOfService() {
  return (
    <div className="terms-of-service">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hewitson Memory Library.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hewitson Memory Library,
            accessible from{" "}
            <a
              href="hewitson-j.github.io/memory-repository"
              rel="external nofollow noopener"
              target="_blank"
            >
              hewitson-j.github.io/memory-repository
            </a>
          </p>
        </li>
        <li>
      ...
      <h2>Accounts and Image Uploads</h2>
      <p>
        You may create an account using Our Website by contacting the site
        administrator through the form at{" "}
        <a
          href="http://hewitson-j.github.io/memory-repository/contact"
          target="_blank"
        >
          hewitson-j.github.io/memory-repository/contact
        </a>
        . By registering an account, you agree to comply with all the terms and
        conditions outlined in this Terms of Service agreement.
      </p>
      <p>
        <ul>
          <li>
            <strong>Ownership and Permissions: </strong>When You submit photos
            to be displayed on Our Website, you represent and warrant that you
            are the rightful copyright owner of the {`image(s)`} and possess all
            necessary rights, licenses, and permissions to grant Us the
            following: <br />
            <br />A non-exclusive, royalty-free, worldwide, irrevocable, and
            sub-licensable right to display, distribute, and reproduce the
            submitted images on Our Website. The ability to modify or adapt the
            images as necessary for optimal website display, without altering
            the core content or artistic integrity of the images.
          </li>
          <br />
          <li>
            <strong>Revocation of Permission:</strong> As the owner of the
            images, You retain the right to revoke permission for the display of
            your images on Our Website at any time. To do so, please contact us
            through the aforementioned contact form, and we will promptly remove
            the images in question within a reasonable timeframe.
          </li>
          <br />
          <li>
            <strong>Owner's Discretion:</strong> We reserve the right, at our
            sole discretion, to decide whether or not to display any images on
            Our Website. We may choose not to display images for any reason,
            including but not limited to, images that violate our content
            guidelines, infringe upon third-party rights, or are otherwise
            deemed inappropriate or harmful.
          </li>
        </ul>
      </p>
      <p>
        We are committed to maintaining the security of all sensitive
        information provided by users. We employ industry-standard security
        measures and protocols to protect user data and ensure compliance with
      ...
      <ul>
        <li>
          <p>By email: jacob.a.hewitson@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="hewitson-j.github.io/memory-repository/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              hewitson-j.github.io/memory-repository/contact
